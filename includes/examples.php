...
wp_set_post_terms($post_id, $webdesign_id, "mbt_genre");
wp_set_post_terms($post_id, $cschmitt_id, "mbt_author");
update_post_meta($post_id, "mbt_buybuttons", unserialize('a:2:{i:0;a:2:{s:4:"type";s:3:"bnn";s:5:"value";s:96:"http://www.barnesandnoble.com/w/designing-web-and-mobile-graphics-christopher-schmitt/1111631892";}i:1;a:2:{s:4:"type";s:6:"amazon";s:5:"value";s:78:"http://www.amazon.com/Designing-Web-Mobile-Graphics-Fundamental/dp/0321858549/";}}'));



//Inspirational
$inspirational = wp_insert_term('Inspirational', 'mbt_genre', array('slug' => 'inspirational'));
$inspirational_id = array($inspirational['term_id']);

//N. J. Lindquist
$njlindquist = wp_insert_term('N. J. Lindquist', 'mbt_author', array('slug' => 'njlindquist'));
$njlindquist_id = array($njlindquist['term_id']);
...
wp_set_post_terms($post_id, $inspirational_id, "mbt_genre");
wp_set_post_terms($post_id, $njlindquist_id, "mbt_author");
update_post_meta($post_id, "mbt_buybuttons", unserialize('a:2:{i:0;a:2:{s:4:"type";s:3:"bnn";s:5:"value";s:106:"http://www.barnesandnoble.com/w/a-second-cup-of-hot-apple-cider-n-j-lindquist/1115136868?ean=9780978496319";}i:1;a:2:{s:4:"type";s:6:"amazon";s:5:"value";s:111:"http://www.amazon.com/Second-Cup-Hot-Apple-Cider/dp/0978496310/ref=sr_1_3?s=books&ie=UTF8&qid=1366743096&sr=1-3'));



//Michael Ryan James
$mrjames = wp_insert_term('Michael Ryan James', 'mbt_author', array('slug' => 'mrjames'));
$mrjames_id = array($mrjames['term_id']);
...
wp_set_post_terms($post_id, $writing_id, "mbt_genre");
wp_set_post_terms($post_id, $mrjames_id, "mbt_author");
update_post_meta($post_id, "mbt_buybuttons", unserialize('a:1:{i:0;a:2:{s:4:"type";s:6:"amazon";s:5:"value";s:35:"http://www.amazon.com/dp/B008R1F446";}}'));



//Thriller
$thriller = wp_insert_term('Thriller', 'mbt_genre', array('slug' => 'thriller'));
$thriller_id = array($thriller['term_id']);

//R. E. McDermott
$remcdermott = wp_insert_term('R. E. McDermott', 'mbt_author', array('slug' => 'remcdermott'));
$remcdermott_id = array($remcdermott['term_id']);
...
wp_set_post_terms($post_id, $thriller_id, "mbt_genre");
wp_set_post_terms($post_id, $remcdermott_id, "mbt_author");
update_post_meta($post_id, "mbt_buybuttons", unserialize('a:2:{i:0;a:2:{s:4:"type";s:3:"bnn";s:5:"value";s:70:"http://www.barnesandnoble.com/w/deadly-straits-re-mcdermott/1103871471";}i:1;a:2:{s:4:"type";s:6:"amazon";s:5:"value";s:68:"http://www.amazon.com/Deadly-Straits-Dugan-Novel-ebook/dp/B0057AMO2A";}}'));



//Mary DeMuth
$mdemuth = wp_insert_term('Mary DeMuth', 'mbt_author', array('slug' => 'mdemuth'));
$mdemuth_id = array($mdemuth['term_id']);
...
wp_set_post_terms($post_id, $writing_id, "mbt_genre");
wp_set_post_terms($post_id, $mdemuth_id, "mbt_author");
update_post_meta($post_id, "mbt_buybuttons", unserialize('a:2:{i:0;a:2:{s:4:"type";s:3:"bnn";s:5:"value";s:104:"http://www.barnesandnoble.com/w/11-secrets-of-getting-published-mary-demuth/1102378897?ean=2940012611758";}i:1;a:2:{s:4:"type";s:6:"amazon";s:5:"value";s:151:"http://www.amazon.com/gp/product/098343672X/ref=as_li_ss_tl?ie=UTF8&tag=wwwrelevantpr-20&linkCode=as2&camp=1789&creative=390957&creativeASIN=098343672X";}}'));



//Christian Living
$christianliving = wp_insert_term('Christian Living', 'mbt_genre', array('slug' => 'christian-living'));
$christianliving_id = array($christianliving['term_id']);

//Nancy Grisham
$ngrisham = wp_insert_term('Nancy Grisham', 'mbt_author', array('slug' => 'ngrisham'));
$ngrisham_id = array($ngrisham['term_id']);
...
wp_set_post_terms($post_id, $christianliving_id, "mbt_genre");
wp_set_post_terms($post_id, $ngrisham_id, "mbt_author");
update_post_meta($post_id, "mbt_buybuttons", unserialize('a:2:{i:0;a:2:{s:4:"type";s:3:"bnn";s:5:"value";s:83:"http://www.barnesandnoble.com/w/thriving-nancy-grisham/1113451228?ean=9780801015434";}i:1;a:2:{s:4:"type";s:6:"amazon";s:5:"value";s:134:"http://www.amazon.com/Thriving-Trusting-God-Life-Fullest/dp/080101543X/ref=sr_1_1?ie=UTF8&qid=1366995488&sr=8-1&keywords=nancy+grisham";}}'));



//Mark Mittleberg
$mmittleberg = wp_insert_term('Mark Mittleberg', 'mbt_author', array('slug' => 'mmittleberg'));
$mmittleberg_id = array($mmittleberg['term_id']);
...
wp_set_post_terms($post_id, $christianliving_id, "mbt_genre");
wp_set_post_terms($post_id, $mmittleberg_id, "mbt_author");
update_post_meta($post_id, "mbt_buybuttons", unserialize('a:2:{i:0;a:2:{s:4:"type";s:3:"bnn";s:5:"value";s:92:"http://www.barnesandnoble.com/w/confident-faith-mark-mittelberg/1113896998?ean=9781414329963";}i:1;a:2:{s:4:"type";s:6:"amazon";s:5:"value";s:153:"http://www.amazon.com/Confident-Faith-Building-Foundation-Beliefs/dp/1414329962/ref=sr_1_2?s=books&ie=UTF8&qid=1367018844&sr=1-2&keywords=confident+faith";}}'));



//Historical Fiction
$historicalfiction = wp_insert_term('Historical Fiction', 'mbt_genre', array('slug' => 'historical-fiction'));
$historicalfiction_id = array($historicalfiction['term_id']);

//Jeanette Vaughan
$jvaughan = wp_insert_term('Jeanette Vaughan', 'mbt_author', array('slug' => 'jvaughan'));
$jvaughan_id = array($jvaughan['term_id']);
...
wp_set_post_terms($post_id, $historicalfiction_id, "mbt_genre");
wp_set_post_terms($post_id, $jvaughan_id, "mbt_author");
update_post_meta($post_id, "mbt_buybuttons", unserialize('a:2:{i:0;a:2:{s:4:"type";s:3:"bnn";s:5:"value";s:115:"http://www.barnesandnoble.com/s/flying-solo-jeanette-vaughan?store=allproducts&keyword=flying+solo+jeanette+vaughan";}i:1;a:2:{s:4:"type";s:6:"amazon";s:5:"value";s:162:"http://www.amazon.com/Flying-Solo-Unconventional-Navigates-Turbulence/dp/061561888X/ref=sr_1_1?ie=UTF8&qid=1366856431&sr=8-1&keywords=jeanette+vaughan+flying+solo";}}'));
