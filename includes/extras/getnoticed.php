	...
	?>
		<div class="wrap mbt_book_importer">
			...
			<?php } else { ?>
				...
				<a href="<?php echo(admin_url('admin.php?page=mbt_import&mbt_import_type=getnoticed&mbt_confirm_import=1')); ?>" class="button button-primary"><?php _e('Import', 'mybooktable'); ?></a>
			<?php } ?>
		</div>
	<?php
}
