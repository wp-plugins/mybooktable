...
Donate link: http://www.mybooktable.com/
Tags: books, authors, ecommerce
...
Yes! This project will be fully open source under the GPLv2 which is the same license that WordPress uses. If you are a hacker/developer and want to help, you can find the development version on GitHub.

= What is the money going towards? =

Development & Tutorial Videos. The money we raise will go towards finishing the development of this project. It will also go towards creating the tutorial videos and launching the plugin.
